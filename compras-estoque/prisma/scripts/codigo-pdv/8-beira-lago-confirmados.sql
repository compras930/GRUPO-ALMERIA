-- Beira Lago — 8 pares confirmados na planilha de conferência.
...
WITH mapa(casa, item, codigo, categoria) AS (VALUES
  ('Beira Lago', 'Socarrat d''Anatra', '70039502530', ''),
  ('Beira Lago', 'Fusilli Lunghi al Pesto Limone', '70039501911', ''),
  ('Beira Lago', 'Croqueta de Sobrasada', '70039501899', ''),
  ('Beira Lago', 'Escalope con Papas', '70039501930', ''),
  ('Beira Lago', 'Insalata di Manzo', '70039502526', ''),
  ('Beira Lago', 'Tagliata alla Tonnata', '70039501927', ''),
  ('Beira Lago', 'Raviolo al Tuorlo Tartufato', '70039501901', ''),
  ('Beira Lago', 'Crudo di Olhete', '70039502517', '')
)
UPDATE "ItemVenda" iv
