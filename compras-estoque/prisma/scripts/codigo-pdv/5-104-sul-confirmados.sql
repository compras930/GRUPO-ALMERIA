-- 104 Sul — 4 pares confirmados na planilha de conferência.
...
WITH mapa(casa, item, codigo, categoria) AS (VALUES
  ('104 Sul', 'Ovos Mexidos Cremosos', '700005000096', ''),
  ('104 Sul', 'Gnocchi Trufado', '735000000097', ''),
  ('104 Sul', 'Mineirinho', '700000000099', ''),
  ('104 Sul', 'Panqueca Banana e Caramelo', '700010000098', '')
)
UPDATE "ItemVenda" iv
